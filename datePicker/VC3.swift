...
class VC3: UIViewController {
    ...
    @objc func doneClicked() {
        ...
        else
        {
            ...
            let startTime = dateFormatter.date(from: dateField.text!)
            
            let timeDifference = userCalender.dateComponents(requestedComponent, from: startTime!, to: datePicker2.date)
            daysLbl.text = ("\(String(timeDifference.day!))Day")
